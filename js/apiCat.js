...
async function showRandomFact() {
    ...
    dataContainer.classList.remove('sm:grid-cols-2', 'lg:grid-cols-3');
    dataContainer.classList.add('grid-cols-1');
    dataContainer.innerHTML = `
...
paginaSiguiente.addEventListener("click", () => {
    numPaginaActual += 1;
    dataContainer.classList.add('sm:grid-cols-2', 'lg:grid-cols-3');
    fetchData();
    mostarBotones();
});
